...
\]
Detailed specifications are provided in \cref{tab:architecture}.

The motivation for these two models builds on the modular framework introduced by \citet{jorgensenSequentialMethodsError2025} (NABQR). The latent model aims to learn a compact representation of the input data for downstream tasks, while the simple model serves as a minimal baseline.
...
Model training was accomplished using Quantile Loss. Defined in \cref{methods:scores}.
